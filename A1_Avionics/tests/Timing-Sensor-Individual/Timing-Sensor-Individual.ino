...
void loop() {
      ...
      unsigned long Acceltime = endtime - starttime; 
      ...
      endtime = micros();
       ...
       unsigned long Gyrotime = endtime - starttime; 
      ...
      unsigned long Magtime = endtime - starttime; 
      Serial.println("Magnet Sensor Time in microseconds: "); 
      Serial.println(Magtime); 
    ...
    endtime = micros();
       ...
       unsigned long PressureTime = endtime - starttime; 
      Serial.println("Pressure Sensor Time in microseconds: "); 
      Serial.println(PressureTime);
    ...
    endtime = micros();
           ...
           unsigned long TemperatureTime = endtime - starttime; 
      Serial.println("Temperature Sensor Time in microseconds: "); 
      Serial.println(TemperatureTime);
