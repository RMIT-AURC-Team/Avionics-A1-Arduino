  ...
  if (currentMicro - previousHighResolutionMicro >= highResolutionInterval) {
    ...
    unsigned long starttime = micros(); 
      ...
      unsigned long endtime = micros(); 
            ...
            unsigned long HighResInterval = endtime - starttime; 
      Serial.println("High Res Interval Time in microseconds: "); 
      Serial.println(HighResInterval);   
  }
  ...
  if (currentMicro - previousLowResolutionMicro >= lowResolutionInterval) {
    ...
    previousLowResolutionMicro = currentMicro;
     ...
     unsigned long endtime = micros(); 
      ...
      unsigned long LowResInterval = endtime - starttime; 
      Serial.println("Low Res Interval Time in microseconds: "); 
      Serial.println(LowResInterval);  
